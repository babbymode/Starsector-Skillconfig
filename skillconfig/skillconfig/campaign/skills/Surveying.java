...
public class Surveying {
	...
	public static final float LEVEL_1_HAZARD = Global.getSettings().getFloat("SLvl1Hazard");
	public static final float LEVEL_2_HAZARD = Global.getSettings().getFloat("SLvl2Hazard");
	public static final float LEVEL_3_HAZARD = Global.getSettings().getFloat("SLvl3Hazard");
	
	public static final float LEVEL_1_COST = Global.getSettings().getFloat("SLvl1Cost");
	public static final float LEVEL_2_COST = Global.getSettings().getFloat("SLvl2Cost");
	public static final float LEVEL_3_COST = Global.getSettings().getFloat("SLvl3Cost");
