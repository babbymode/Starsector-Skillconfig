...
public class CoordinatedManeuvers {
	...
	public static final float LEVEL_1_BONUS = Global.getSettings().getFloat("CMLvl1Bonus");
	public static final float LEVEL_2_BONUS = Global.getSettings().getFloat("CMLvl2Bonus");
	public static final float LEVEL_3_BONUS = Global.getSettings().getFloat("CMLvl3Bonus");
