...
public class FighterDoctrine {
	...
	public static final float FIGHTER_CREW_LOSS_REDUCTION = Global.getSettings().getFloat("FDFighterCrewLossReduction");
	public static final float FIGHTER_RAMAGE_REDUCTION = Global.getSettings().getFloat("FDFighterRamageReduction");
	public static final float FIGHTER_REPLACEMENT_RATE_BONUS = Global.getSettings().getFloat("FDFighterReplacementRateBonus");
