...
public class AdvancedCountermeasures {
    ...
    public static final float PERSONAL_ARMOR_KINETIC_REDUCTION = Global.getSettings().getFloat("ACPersonalKineticDamageReduction");
    public static final float FLEET_ARMOR_KINETIC_REDUCTION = Global.getSettings().getFloat("ACFleetArmorKineticDamageReduction");
    public static final float PERSONAL_SHIELD_HE_REDUCTION = Global.getSettings().getFloat("ACPersonalShieldHighExplosiveReduction");
    public static final float FLEET_SHIELD_HE_REDUCTION = Global.getSettings().getFloat("ACFleetShieldHighExplosiveReduction");
    public static final float PERSONAL_FIGHTER_DAMAGE_BONUS = Global.getSettings().getFloat("ACPersonalFighterDamageBonus");
    public static final float FLEET_FIGHTER_DAMAGE_BONUS = Global.getSettings().getFloat("ACFleetFighterDamageBonus");
    public static final float PERSONAL_MISSILE_DAMAGE_BONUS = Global.getSettings().getFloat("ACPersonalMissileDamageBonus");
    public static final float FLEET_MISSILE_DAMAGE_BONUS = Global.getSettings().getFloat("ACFleetMissileDamageBonus");
