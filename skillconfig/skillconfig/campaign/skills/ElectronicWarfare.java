...
public class ElectronicWarfare {
	...
	public static final float LEVEL_1_BONUS = Global.getSettings().getFloat("EWLvl1Bonus");
	public static final float LEVEL_2_BONUS = Global.getSettings().getFloat("EWLvl2Bonus");
	public static final float LEVEL_3_BONUS = Global.getSettings().getFloat("EWLvl3Bonus");
