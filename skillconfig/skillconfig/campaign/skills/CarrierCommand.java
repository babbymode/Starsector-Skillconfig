...
public class CarrierCommand {
	...
	public static final float FIGHTER_CREW_LOSS_REDUCTION = Global.getSettings().getFloat("CCFighterCrewLossReduction");
	public static final float FIGHTER_RAMAGE_REDUCTION = Global.getSettings().getFloat("CCFighterRamageReduction");
	public static final float FIGHTER_REPLACEMENT_RATE_BONUS = Global.getSettings().getFloat("CCFighterReplacementRateBonus");
