...
public class CoordinatedManeuversScript extends BaseEveryFrameCombatPlugin {
	...
	public static final float BASE_MAXIMUM = Global.getSettings().getFloat("CMBaseMaximum");
	public static final float PER_BUOY = Global.getSettings().getFloat("CMPerBuoy");
