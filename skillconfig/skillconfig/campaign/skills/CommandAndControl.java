...
public class CommandAndControl {
	...
	public static final float RATE_BONUS = Global.getSettings().getFloat("CACRateBonus");
	public static final float CP_BONUS = Global.getSettings().getFloat("CACCPBonus");
	
	public static final float CM_BONUS = Global.getSettings().getFloat("CACCMBonus");
	public static final float EW_BONUS = Global.getSettings().getFloat("CACEWBonus");
