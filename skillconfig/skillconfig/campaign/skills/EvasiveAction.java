...
public class EvasiveAction {
    ...
    public static final float PERSONAL_MANEUVERABILITY_BONUS = Global.getSettings().getFloat("EAPersonalManeuverabilityBonus");
    public static final float FLEET_MANEUVERABILITY_BONUS = Global.getSettings().getFloat("EAFleetManeuverabilityBonus");
    public static final float PERSONAL_DAMAGE_TO_MODULES_REDUCTION = Global.getSettings().getFloat("EAPersonalDamageToModulesReduction");
    public static final float FLEET_DAMAGE_TO_MODULES_REDUCTION = Global.getSettings().getFloat("EAFleetDamageToModulesReduction");
    public static final float PERSONAL_EFFECTIVE_ARMOR_BONUS = Global.getSettings().getFloat("EAPersonalEffectiveArmorBonus");
    public static final float FLEET_EFFECTIVE_ARMOR_BONUS = Global.getSettings().getFloat("EAFleetEffectiveArmorBonus");
