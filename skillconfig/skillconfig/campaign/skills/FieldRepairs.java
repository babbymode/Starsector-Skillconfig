...
public class FieldRepairs {
	...
	public static final float MIN_HULL = Global.getSettings().getFloat("FRMinHull");
	public static final float MAX_HULL = Global.getSettings().getFloat("FRMaxHull");
	
	public static final float MIN_CR = Global.getSettings().getFloat("FRMinCR");
	public static final float MAX_CR = Global.getSettings().getFloat("FRMaxCR");
	
	public static final float INSTA_REPAIR = Global.getSettings().getFloat("FRInstaRepair");
	
	public static final float REPAIR_RATE_BONUS = Global.getSettings().getFloat("FRRepairRateBonus");
