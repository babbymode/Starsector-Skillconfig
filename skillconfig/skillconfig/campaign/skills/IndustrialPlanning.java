...
public class IndustrialPlanning {
	...
	public static int DEMAND_REDUCTION = (int)Global.getSettings().getFloat("IPDemandReduction");
	public static int SUPPLY_BONUS = (int)Global.getSettings().getFloat("IPSupplyBonus");
	public static float INCOME_MULT = Global.getSettings().getFloat("IPIncomeMult");
	public static float UPKEEP_MULT = Global.getSettings().getFloat("IPUpkeepMult");
