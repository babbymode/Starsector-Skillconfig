...
public class FleetLogistics {
	...
	public static final float ACCESS_1 = Global.getSettings().getFloat("FLAccess1");
	public static final float ACCESS_2 = Global.getSettings().getFloat("FLAccess2");
	public static final float FLEET_SIZE = Global.getSettings().getFloat("FLFleetSize");
	
	public static final float REPAIR_RATE_INCREASE = Global.getSettings().getFloat("FLRepairRateIncrease");
	
	public static final float OFFICER_SHIP_RECOVERY_MOD = Global.getSettings().getFloat("FLOfficerShipRecoveryMod");
	public static final float MAINTENANCE_COST_REDUCTION = Global.getSettings().getFloat("FLMaintenanceCostReduction");
	public static final float MAX_CR_BONUS = Global.getSettings().getFloat("FLMaxCRBonus");
