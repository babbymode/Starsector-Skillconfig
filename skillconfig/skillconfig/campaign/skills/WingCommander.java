...
public class WingCommander {
	...
	public static final float SPEED_BONUS = Global.getSettings().getFloat("WCSpeedBonus");
	public static final float DAMAGE_TO_FIGHTERS_BONUS = Global.getSettings().getFloat("WCDamageToFightersBonus");
	public static final float DAMAGE_TO_MISSILES_BONUS = Global.getSettings().getFloat("WCDamageToMissilesBonus");
	public static final float TARGET_LEADING_BONUS = Global.getSettings().getFloat("WCTargetLeadingBonus");
