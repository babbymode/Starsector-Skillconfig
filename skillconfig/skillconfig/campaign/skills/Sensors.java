...
public class Sensors {
	...
	public static final float DETECTED_BONUS = Global.getSettings().getFloat("SDetectedBonus");
	public static final float GO_DARK_MULT = Global.getSettings().getFloat("SGoDarkMult");
	public static final float SENSOR_BONUS = Global.getSettings().getFloat("SSensorBonus");
	public static final float SENSOR_BURST_PENALTY_MULT = Global.getSettings().getFloat("SSensorBurstPenaltyMult");
	...
	public static class Level2B implements FleetStatsSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "Amplifies the effectiveness of the \"Go Dark\" ability";
		}
