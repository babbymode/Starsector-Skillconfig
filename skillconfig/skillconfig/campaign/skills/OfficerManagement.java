...
public class OfficerManagement {
	...
	public static final float LEVEL_1_BONUS = Global.getSettings().getFloat("OMLvl1Bonus");
	public static final float LEVEL_2_BONUS = Global.getSettings().getFloat("OMLvl2Bonus");
	public static final float LEVEL_3_BONUS = Global.getSettings().getFloat("OMLvl3Bonus");
