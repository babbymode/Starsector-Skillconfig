...
public class PlanetaryOperations {
	...
	public static int LEVEL_1_BONUS = (int)Global.getSettings().getFloat("POLvl1Bonus");
	public static int LEVEL_2_BONUS = (int)Global.getSettings().getFloat("POLvl2Bonus");
	
	public static float STABILITY_BONUS = Global.getSettings().getFloat("POStabilityBonus");
