...
public class Navigation {
	...
	public static final float TERRAIN_PENALTY_REDUCTION = Global.getSettings().getFloat("NTerrainPenaltyReduction");
	public static final float FUEL_USE_REDUCTION = Global.getSettings().getFloat("NFuelUseReduction");
	//public static final float SUSTAINED_BURN_BONUS = 5;
	public static final float FLEET_BURN_BONUS = Global.getSettings().getFloat("NFleetBurnBonus");
	public static final float SB_BURN_BONUS = Global.getSettings().getFloat("NSBBurnBonus");
