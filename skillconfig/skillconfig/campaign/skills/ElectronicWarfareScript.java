...
public class ElectronicWarfareScript extends BaseEveryFrameCombatPlugin {
	...
	public static final float BASE_MAXIMUM = Global.getSettings().getFloat("EWBaseMaximum");
	public static final float PER_JAMMER = Global.getSettings().getFloat("EWPerJammer");
