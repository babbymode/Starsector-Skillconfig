...
public class TargetAnalysis {
    ...
    public static final float PERSONAL_DAMAGE_TO_MODULES_BONUS = Global.getSettings().getFloat("TAPersonalDamageToModulesBonus");
    public static final float FLEET_DAMAGE_TO_MODULES_BONUS = Global.getSettings().getFloat("TAFleetDamageToModulesBonus");
    public static final float PERSONAL_DAMAGE_TO_SHIELDS_BONUS = Global.getSettings().getFloat("TAPersonalDamageToShieldsBonus");
    public static final float FLEET_DAMAGE_TO_SHIELDS_BONUS = Global.getSettings().getFloat("TAFleetDamageToShieldsBonus");
    public static final float PERSONAL_HIT_STRENGTH_BONUS = Global.getSettings().getFloat("TAPersonalHitStrengthBonus");
    public static final float FLEET_HIT_STRENGTH_BONUS = Global.getSettings().getFloat("TAFleetHitStrengthBonus");
