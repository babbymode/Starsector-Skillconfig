...
public class OrdnanceExpertise {
    ...
    public static final float PERSONAL_PROJ_SPEED_BONUS_L1 = Global.getSettings().getFloat("OEPersonalProjSpeedBonusLvl1");
    public static final float FLEET_PROJ_SPEED_BONUS_L1 = Global.getSettings().getFloat("OEFleetProjSpeedBonusLvl1");
    public static final float PERSONAL_PROJ_SPEED_BONUS_L2 = Global.getSettings().getFloat("OEPersonalProjSpeedbonusLvl2");
    public static final float PERSONAL_WEAPON_HITPOINTS_BONUS_L1 = Global.getSettings().getFloat("OEPersonalWeaponHitpointsBonusLvl1");
    public static final float PERSONAL_WEAPON_HITPOINTS_BONUS_L2 = Global.getSettings().getFloat("OEPersonalWeaponHitpointsBonusLvl2");
    public static final float FLEET_WEAPON_HITPOINTS_BONUS = Global.getSettings().getFloat("OEFleetWeaponHitpointsBonus");
    public static final float PERSONAL_DAMAGE_BONUS = Global.getSettings().getFloat("OEPersonalDamageBonus");
    public static final float FLEET_DAMAGE_BONUS = Global.getSettings().getFloat("OEFleetDamageBonus");
