...
public class GunneryImplants {
	...
	public static final float RECOIL_BONUS = Global.getSettings().getFloat("GIRecoilBonus");
	public static final float TARGET_LEADING_BONUS = Global.getSettings().getFloat("GITargetLeadingBonus");
	public static final float RANGE_BONUS = Global.getSettings().getFloat("GIRangeBonus");
