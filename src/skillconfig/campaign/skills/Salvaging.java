...
public class Salvaging {
	...
	public static final float LEVEL_1_SALVAGE_RATING = Global.getSettings().getFloat("SLvl1SalvageRating");
	public static final float LEVEL_2_SALVAGE_RATING = Global.getSettings().getFloat("SLvl2SalvageRating");
	public static final float LEVEL_3_SALVAGE_RATING = Global.getSettings().getFloat("SLvl3SalvageRating");
	
//	public static final float LEVEL_1_COMBAT_SALVAGE = 5f;
//	public static final float LEVEL_2_COMBAT_SALVAGE = 5f;
	public static final float LEVEL_3_COMBAT_SALVAGE = Global.getSettings().getFloat("SLvl3CombatSalvage");
