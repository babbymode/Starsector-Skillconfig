...
public class RecoveryOperations {
	...
	public static final float OWN_WEAPON_WING_RECOVERY_BONUS = Global.getSettings().getFloat("ROOwnWeaponWingRecoveryBonus");
//	public static final float ENEMY_WEAPON_WING_RECOVERY_BONUS = 15f;
//	public static final float SHIP_RECOVERY_BONUS = 15f;
	public static final float ENEMY_WEAPON_WING_RECOVERY_BONUS = Global.getSettings().getFloat("ROEnemyWeaponWingRecoveryBonus");
	public static final float SHIP_RECOVERY_BONUS = Global.getSettings().getFloat("ROShipRecoveryBonus");
	public static final float DMOD_REDUCTION = Global.getSettings().getFloat("RODmodReduction");
	public static final float CREW_LOSS_REDUCTION = Global.getSettings().getFloat("ROCrewLossReduction");
	
	public static final float REPAIR_RATE_BONUS = 100f;
	
	//public static final float COMBAT_SALVAGE_BONUS = 10f;
	public static final float FUEL_SALVAGE_BONUS = Global.getSettings().getFloat("ROFuelSalvageBonus");
