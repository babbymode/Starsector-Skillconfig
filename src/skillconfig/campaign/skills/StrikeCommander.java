...
public class StrikeCommander {
	...
	public static final float MISSILE_SPEED_BONUS = Global.getSettings().getFloat("SCMissileSpeedBonus");
	public static final float MISSILE_RANGE_MULT = Global.getSettings().getFloat("SCMissileRangeMult");
	
	public static final float MISSILE_HITPOINTS_BONUS = Global.getSettings().getFloat("SCMissileHitpointsBonus");
	public static final float STRIKE_DAMAGE_BONUS = Global.getSettings().getFloat("SCStrikeDamageBonus");
