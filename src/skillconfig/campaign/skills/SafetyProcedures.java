...
public class SafetyProcedures {
	...
	public static final float CORONA_EFFECT_MULT = Global.getSettings().getFloat("SPCoronaEffectMult");
	public static final float CREW_LOSS_REDUCTION = Global.getSettings().getFloat("SPCrewLossReduction");
	public static final float CR_MALFUNCTION_RANGE_MULT = Global.getSettings().getFloat("SPCRMalfunctionRangeMult");
	
	public static final float DMOD_EFFECT_MULT = Global.getSettings().getFloat("SPDmodEffectMult");
	...
	public static class Level2B implements ShipSkillEffect {
		...
		public String getEffectDescription(float level) {
			return "Negative effects of \"lasting damage\" hullmods (d-mods) reduced by " + (int)(100f * (1f - DMOD_EFFECT_MULT)) + "%";
		}
