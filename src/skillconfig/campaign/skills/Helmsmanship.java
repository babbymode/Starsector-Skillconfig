...
public class Helmsmanship {
    ...
    public static float PERSONAL_ACCELERATION_BONUS = Global.getSettings().getFloat("HPersonalAccelerationBonus");
    public static float FLEET_ACCELERATION_BONUS = Global.getSettings().getFloat("HFleetAccelerationBonus");
    public static float PERSONAL_SPEED_BONUS = Global.getSettings().getFloat("HPersonalSpeedBonus");
    public static float FLEET_SPEED_BONUS = Global.getSettings().getFloat("HFleetSpeedBonus");
    public static float PERSONAL_ZERO_FLUX_LEVEL = Global.getSettings().getFloat("HPersonalZeroFluxLevel"); //but not for carriers
    public static float FLEET_ZERO_FLUX_LEVEL = Global.getSettings().getFloat("HFleetZeroFluxLevel");
