...
public class ColonyManagement {
	...
	public static int ADMINS = (int)Global.getSettings().getFloat("ColManAdmins");
	public static int LEVEL_2_BONUS = (int)Global.getSettings().getFloat("ColManLvl2Bonus");
	public static int LEVEL_3_BONUS = (int)Global.getSettings().getFloat("ColManLvl3Bonus");
