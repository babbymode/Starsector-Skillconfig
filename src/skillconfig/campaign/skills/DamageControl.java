...
public class DamageControl {
    ...
    public static final float PERSONAL_INSTA_REPAIR = Global.getSettings().getFloat("DCPersonalInstaRepair");
    public static final float FLEET_INSTA_REPAIR = Global.getSettings().getFloat("DCFleetInstaRepair");

    public static final float PERSONAL_CREW_LOSS_REDUCTION = Global.getSettings().getFloat("DCPersonalCrewLossReduction");
    public static final float FLEET_CREW_LOSS_REDUCTION = Global.getSettings().getFloat("DCFleetCrewLossReduction");

    public static final float PERSONAL_MODULE_REPAIR_BONUS = Global.getSettings().getFloat("DCPersonalModuleRepairBonus");
    public static final float FLEET_MODULE_REPAIR_BONUS = Global.getSettings().getFloat("DCFleetModuleRepairBonus");

    public static final float PERSONAL_HULL_DAMAGE_REDUCTION = Global.getSettings().getFloat("DCPersonalHullDamageReduction");
    public static final float FLEET_HULL_DAMAGE_REDUCTION = Global.getSettings().getFloat("DCFleetHullDamageReduction");
    public static final float PERSONAL_OVERLOAD_REDUCTION = Global.getSettings().getFloat("DCPersonalOverloadReduction");
    public static final float FLEET_OVERLOAD_REDUCTION = Global.getSettings().getFloat("DCFleetOverloadReduction");
